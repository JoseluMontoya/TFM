...
\begin{figure}[t]
\centering
  \includesvg[width=\linewidth]{RLCKinetic/IdealContrastOfRp&Lf&CcDefense.svg}
\end{figure}
\end{frame}
...
% \begin{figure}[t]
% \centering
%   \includesvg[width=\linewidth]{RLCKinetic/IdealComplexContrastOfRp&Lf&CcDefense.svg}
% \end{figure}
% \end{frame}
...
\begin{figure}[t]
\centering
  \includesvg[width=\linewidth]{RLCKinetic/ImprovementsOfRp.svg}
\end{figure}
\end{frame}
